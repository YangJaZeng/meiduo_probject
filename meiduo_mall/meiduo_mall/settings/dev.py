...
SECRET_KEY = 'uqy05zccot#=%1b+q5z-upo-gw)xamd(h(bity0br8ia@o^=6a'
...
# 发送邮件的邮箱
EMAIL_HOST_USER = '18079308731@163.com'
# 在邮箱中设置的客户端授权密码
...
FDFS_URL = 'http://192.168.245.128:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.245.128:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
